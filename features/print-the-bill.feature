...
Escenario: imprimir la factura de BigCo en texto plano en ARS
   Dado el listado de la facturación de espectáculos
      """
      {
      "customer": "BigCo",
   ...
   Y la lista de obras
      ...
      """
   Cuando mando a imprimir el borderau en ARS
   Entonces debería imprimir el borderau en ARS
      """
      Statement for BigCo
        Hamlet: $650,00 (55 seats)
        As You Like It: $580,00 (35 seats)
...
Escenario: imprimir la factura de BigCo en HTML en ARS
   Dado el listado de la facturación de espectáculos
      """
      {
      "customer": "BigCo",
   ...
   Y la lista de obras
      ...
      """
   Cuando mando a imprimir el borderau en HTML en ARS
   Entonces debería imprimir el borderau en HTML en ARS
      """
      <h1>Statement for BigCo</h1>
      <table>
      <tr><th>play</th><th>seats</th><th>cost</th></tr>
